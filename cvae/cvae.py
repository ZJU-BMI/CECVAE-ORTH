...
class cfr_net(object):
    """
    cvae implements the CECVAE-ORTH proposed by J. Chu et. al. "Disentangled Representation Learning with Variational\
     Inference: A Method for Treatment Effect Estimation" (under review)
